...
const Footer = () => {
  return (
    <div className='mt-20 sm:mt-40 bg-[#153403] text-[#cdeeb9] m-auto  py-5'>
      <div className='grid grid-cols-1 md:grid-cols-2 border-b pb-10 border-[#cdeeb9]  text-center'>
        <div className='mt-10 md:border-e border-[#cdeeb9]'>
