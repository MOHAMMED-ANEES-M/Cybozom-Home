...
const Main = () => {
  ...
  return (
    <div className=' mt-28 md:mt-40'>
      ...
      <div className='mt-20 sm:mt-32 grid grid-cols-1 md:grid-cols-2 gap-10 mx-[5%] items-center'>
        <div>
          <h1 className='text-3xl sm:text-4xl md:text-5xl tracking-widest font-semibold text-[#153403]'>GET IN TOUCH</h1>
          <p className='mt-10'>4th Floor, CD TOWER, Mini Bypass Rd, Arayidathupalam, Kozhikode, Kerala 673004</p>
        </div>
